...
import 'package:payments/interface/screens/index.dart';
...
Future<void> main() async {
  ...
  runApp(
    MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => AgentActors()),
        ChangeNotifierProvider(create: (_) => UserActors()),
        ChangeNotifierProvider(create: (_) => FinanceActors()),
      ],
      child: const MyApp(),
    ),
  );

  // make the app remain in portrait mode always. Prevent rotation.
