...
class TransfersReport extends StatefulWidget {
  const TransfersReport({Key? key}) : super(key: key);

  @override
  State<TransfersReport> createState() => _TransfersReportState();
}

class _TransfersReportState extends State<TransfersReport> {
  List transfers = [];
  ...
  Future fetchAgentTransfers() async {
    ...
    dynamic getAgentTransactionsIfExists = await ApiHelperFunctions.getAgentTransfers(agentId: agentActor.agentModel_.agentId!);
          ...
          child: ListView(
              ...
              children:[
                Padding(
                  ...
                  child: Text(
                    'Showing transfers for Agent ${agentActor.agentModel_.agentNumber}',
                    style: TextStyle(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${tx['StatusCode'] == 2001 ? 'Failed' :
                                      tx['StatusCode'] == 2000 ? 'Success' :
                                      tx['StatusCode'] == 2002 ? 'Success' :
                                          'Failed'
                                      }",
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
